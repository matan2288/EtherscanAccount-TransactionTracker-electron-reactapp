  ...
  const getDataFromApi = async () => {
    await fetch(
      ...
      `https://api.etherscan.io/api?module=account&action=txlist&address=${
        "0x" + txnHash
      }&endblock=99999999&page=page&offset=10&sort=ascd&apikey=${
        process.env.PERSONAL_ETHERSCAN_APIKEY
      }`
    )
      ...
      <div className="top-content">
        ...
        <div className="top-content-child1">
          ...
          <p className="instructions">
            ...
            <p className="acc-id">
              0x<b>ee41fe01a8f7eef0a90c5b181472ef3a9412e7b9</b>
            </p>
          </p>
        ...
        <div className="top-content-child2">
          <div>
            <span className="refresh-next100" onClick={nextTransactions}>
              Show the next 100 Transactions
            </span>
            /
            <span className="refresh-next100" onClick={refreshTable}>
              Refresh Table
            </span>
            ...
            <button className="btn-2" onClick={evokeAddingTransactionsBtn}>
              Go
            </button>
          </div>
        </div>
